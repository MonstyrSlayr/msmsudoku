...
const mainSudoku = document.getElementById("mainSudoku");
const daFinalizer = document.getElementById("daFinalizer");
...
async function handleFiles(files)
{
    ...
    const json = await decryptFile(file);

    dropZone.classList.add("gone");
    textFields.classList.remove("gone");
    mainSudoku.classList.remove("gone");
    daFinalizer.classList.remove("gone");
